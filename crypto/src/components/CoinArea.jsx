  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-900 via-gray-900/95 to-gray-900/90 text-white px-4 sm:px-[5%] py-6 md:py-10 relative z-0'>
      <div className='text-center mb-8 md:mb-12 space-y-4 group relative'>
        ...
        <p className='text-gray-300/80 mx-auto text-sm sm:text-base md:text-lg leading-relaxed mt-4'>
          Track real-time crypto market metrics with advanced analytics and
          <span className='bg-gradient-to-r from-emerald-400/80 to-cyan-500/80 bg-clip-text text-transparent mx-2'>
      ...
      {isCurrencyDropdownOpen && (
        <div className='relative bg-gray-800/95 backdrop-blur-xl rounded-lg border border-emerald-500/20 shadow-2xl z-50 mb-6'>
      ...
      <div className='space-y-4 relative z-10'>
        {filteredCryptos.slice(0, 12).map((item) => (
          <Link
            to={`/crypto/${item.id}`}
            key={item.id}
            className='block p-6 bg-gray-800/30 backdrop-blur-md hover:bg-gray-700/40 rounded-2xl
          ...
          >
            <div className='flex items-center justify-between'>
              ...
              <div className='text-right'>
                ...
                <p className={`text-sm ${item.price_change_percentage_24h >= 0 ? 'text-green-400' : 'text-red-400'}`}>
            ...
            <div className=' hidden md:grid grid-cols-5 gap-4 items-center'>
                ...
                <div className=' flex items-center gap-3'>
                    ...
                    bg bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 p-0.5'/>
                    <div>
                ...
                <p className=' text-sm lg:text-base text-gray-100'>
                    {currentCurrency.symbol}{item.market_cap_rank.toLocaleString()}
                </p>
